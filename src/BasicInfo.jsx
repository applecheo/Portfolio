  ...
  return (
    <>
      ...
      >
        ...
        <p style={{ margin: 10, maxWidth: 400 }}>
          ...
          the courage to try it out myself. Hence, I proceeded to do my Diploma
          in Marine Science and Aquaculture. After my internship, I am more
          affirmed that I want to be in the tech industry hence I took a leap of
          faith to try out programming and immediately fell in love.
        </p>
      </div>
      <div
        style={{
